  ...
  return (
    <Box>
      <Box mt="20px" sx={{ display: 'flex', flexWrap: 'wrap', gap: 3 }}>
        ...
        <Box mt={3} mb={2} display="flex" width="84%" justifyContent="space-between" flexWrap="wrap">
          <Box display="flex" gap={2} flexWrap="wrap" mb={{ xs: '20px', sm: 0 }}>
            ...
            >
              ...
              {['Appartment', 'Villa', 'Farmhouse', 'Condos', 'Townhouse', 'Duplex', 'Studio', 'Chalet'].map((type) => (
