  ...
  return (
    <Box>
      ...
      <Box mt="20px" display="flex" flexWrap="wrap" gap={4} >
        ...
        <PieChart title="Properties for Rent" value={580} series={[60, 40]} colors={['#275be8', '#c4e8ef']} />

        <PieChart title="Total customers" value={5684} series={[75, 25]} colors={['#275be8', '#c4e8ef']} />

        <PieChart title="Propreties of Cities" value={555} series={[75, 25]} colors={['#275be8', '#c4e8ef']} />
      </Box>
